...
object Launcher extends LogSupport {
  ...
  private[Launcher] class CommandDef(val method: ObjectMethod, val command: command) extends Command with LogSupport {
...
/**
  ...
  * @author leo
  */
class Launcher(cl: Class[_]) extends LogSupport {
